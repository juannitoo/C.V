function tooltips() {
    ...
    tooltipStJean.innerHTML = `<h2><a href="https://www.locationsaintjeandeluz.fr" alt="lien location saint jean" target="_blank">locationsaintjeandeluz</a></h2>`
    ...
    tooltipIparglass.innerHTML = `<h2><a href="https://www.iparglass.fr" alt="lien iparglass" target="_blank">Iparglass</a></h2>`
    ...
    tooltipGithub.innerHTML = `<h2><a href="https://github.com/juannitoo" alt="lien github perso" target="_blank">Github</a></h2>`
